...
@Schema(description = "Data structure of a reservation. A reservation can be of type 'RFID' or 'BTLE' (Bluetooth) " +
...
public class ReservationRequestRestDto {
    ...
    @Schema(name = "reservationId", description = "The reservation ID. Leave empty for new reservations. " +
            "Required for reservation changes only.")
    private Long reservationId;

    @Deprecated
    @Schema(name = "driverTagId", description = "DEPRECATED: The driver tag id (RFID). " +
            "This is for backward compatibility only. For new implementations use object 'rfid' instead!")
    private String driverTagId;

    @Schema(name = "rfid",
            description = "The additional metadata for a RFID reservation. Required for reservations of type 'RFID'"
            + ". Leave empty for reservations of type 'BTLE' (Bluetooth).")
    private Rfid rfid;

    @Schema(name = "btle",
            description = "The additional metadata for a Bluetooth reservation. Required for reservations of type " +
                    "'BTLE' (Bluetooth). Leave empty for reservations of type 'RFID'.")
    private Btle btle;

    @Schema(name = "from",
            description = "The date and time the reservation is valid from. This property is generally optional but" +
                    " required, when a valid until date/time is given.")
    private Date from;

    @Schema(name = "until",
            description = "The date and time the reservation is valid until. This property is generally optional " +
                    "but required, when a valid from date/time is given.")
    private Date until;

    @Value
    @lombok.Builder(builderClassName = "Builder")
    @Schema(name = "RequestRfid", description = "The additional metadata for a reservation of type 'RFID'.")
    ...
    @Value
    @lombok.Builder(builderClassName = "Builder")
    @Schema(name = "RequestBtle", description = "The additional metadata for a reservation of type 'BTLE' (Bluetooth).")
    public static class Btle {
        ...
        @Schema(name = "appId", description = "Required. The application id.", required = true)
        private String appId;

        @lombok.Builder.Default
        @Schema(name = "version", description = "Required. The certificate version.", required = true)
        private int version = 1;

        @Schema(name = "mobileSerialNumber",
                description = "Required. The mobile serial number (mosn).",
                required = true)
